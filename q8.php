...
<body>
    <div class="quiz-container">
        ...
        <div class="question-text">
            <p> What was the first book of the Bible?</p>
        </div>
        ...
        <form action="q8.php" method="post">
            <div class="options-container">
                <div class="option">
                    ...
                    <label for="option-a">Genesis</label>
                </div>
                <div class="option">
                    <input type="radio" value="b" name="q2" id="option-b">
                    <label for="option-b">Exodus</label>
                </div>
            </div>
