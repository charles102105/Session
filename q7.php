...
<body>
    <div class="quiz-container">
        ...
        <div class="question-text">
            <p> Who betrayed Jesus for 30 pieces of silver?</p>
        </div>
        ...
        <form action="q7.php" method="post">
            <div class="options-container">
                <div class="option">
                    ...
                    <label for="option-a">Peter</label>
                </div>
                <div class="option">
                    <input type="radio" value="b" name="q2" id="option-b">
                    <label for="option-b">Judas</label>
                </div>
            </div>
