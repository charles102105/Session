...
<body>
    <div class="quiz-container">
        ...
        <div class="question-text">
            <p> Who was the strongest man in the Bible?</p>
        </div>
        ...
        <form action="q9.php" method="post">
            <div class="options-container">
                <div class="option">
                    ...
                    <label for="option-a">Samson</label>
                </div>
                <div class="option">
                    <input type="radio" value="b" name="q2" id="option-b">
                    <label for="option-b">Solomon</label>
                </div>
            </div>
