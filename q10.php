...
<body>
    <div class="quiz-container">
        ...
        <div class="question-text">
            <p> What did David use to defeat Goliath?</p>
        </div>
        ...
        <form action="q10.php" method="post">
            <div class="options-container">
                <div class="option">
                    ...
                    <label for="option-a">Sword</label>
                </div>
                <div class="option">
                    <input type="radio" value="b" name="q2" id="option-b">
                    <label for="option-b">Slingshot</label>
                </div>
            </div>
