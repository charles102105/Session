...
<body>
    <div class="quiz-container">
        ...
        <div class="question-text">
            <p> How many days did God take to create the world?</p>
        </div>
        ...
        <form action="q6.php" method="post">
            <div class="options-container">
                <div class="option">
                    ...
                    <label for="option-a">6 days</label>
                </div>
                <div class="option">
                    <input type="radio" value="b" name="q2" id="option-b">
                    <label for="option-b">7 days</label>
                </div>
            </div>
